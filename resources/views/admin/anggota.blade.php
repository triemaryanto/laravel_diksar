...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Data Anggota KSP DIAN MANDIRI</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row g-3 align-items-center mt-2">
                <form action="#" method="get">
                    <div class="col-auto">
                        ...
                        <select class="form-select" aria-label="Default select example" name="cari">
                            <option value="anggotas.username">ID Anggota</option>
                ...
                <div class="col-auto">
                    <a href="/admin/pdfanggota" value="{{ request('search')}}" class="btn btn-danger">Export PDF</a>
                </div>
                <div class="col-auto">
                    <a href="/admin/excelanggota" class="btn btn-success">Export Excel</a>
                </div>
